    ...
    <tr valign="top">
        @for ($i=0; $i<sizeof($Arr_category); $i = $i + 2)
            <td>
                <table width="100%">
                    <tr>
                        <th colspan="2" style="text-align: left; padding-left: 10px; font-size: 14pt;">{{ucfirst(strtolower($Arr_category[$i]->name))}}</th>
                    ...
                    @endfor
                    <tr>
                        <th colspan="2" style="text-align: left; padding-left: 10px; padding-top: 10px; font-size: 14pt;">{{ucfirst(strtolower($Arr_category[$i + 1]->name))}}</th>
                        <th style="font-size: 10pt;" valign="bottom">Score</th>
                    </tr>
